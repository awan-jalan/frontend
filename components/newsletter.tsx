          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Want more information or join community with us?</h3>
                <p className="text-gray-300 text-lg mb-6">Get in touch with us to receive more information or join our dynamic network of passionate agribusiness enthusiasts. Together, let's cultivate knowledge, forge meaningful connections, and embark on a journey of growth and innovation in the agricultural realm.</p>
